    ...
    <div className="pro-auth-container" data-theme={theme}>
      ...
      <div className="pro-auth-left">
        ...
        <div className="pro-auth-quote">
          <h2>Welcome back to premium commerce.</h2>
          <p>Discover endless premium products, tailored for your taste. Sign in to seamlessly manage your orders and track your shipments.</p>
        </div>
      ...
      <div className="pro-auth-right">
        <div className="pro-auth-form-wrapper">
          ...
          <form className="pro-form" onSubmit={onSubmit}>
            ...
            <div className="pro-form-actions">
              <label className="pro-checkbox">
                <input type="checkbox" className="pro-checkbox-input" />
                <span className="pro-checkbox-box">
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                    <polyline points="20 6 9 17 4 12"></polyline>
                  </svg>
                </span>
                <span className="pro-checkbox-text">Remember me</span>
              </label>
          ...
          <p className="pro-status" aria-live="polite">{status && status !== 'Signed out' ? status : ''}</p>
